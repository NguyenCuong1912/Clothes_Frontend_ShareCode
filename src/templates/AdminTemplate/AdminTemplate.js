    ...
    return <Route {...restRoute} render={(propsRoute) => {
        return <Fragment>
            <Layout style={{ minHeight: '100vh' }}>
                <Sider className='border-r' collapsible collapsed={collapsed} onCollapse={(value) => setCollapsed(value)} style={{ backgroundColor: '#333F48' }}>
                    <div onClick={() => {
                        history.push(`${_home}`)
                    }} className="flex justify-center my-4 cursor-pointer" title='Trang chủ'>
                ...
                <Layout className="site-layout">
                    <Header style={{ padding: 0, backgroundColor: '#333F48' }}>
